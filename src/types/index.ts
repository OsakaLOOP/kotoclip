...
export interface DictionaryCandidate extends DictionaryLink { candidate_id: string; dictionary_names: string[]; reading: string | null; entry_kind: string; occurrence_ids: string[]; }
...
export interface DictionaryLookup { query: string; reading: string | null; selected_target: string | null; selected_occurrence_id?: string | null; mode: string; candidates: DictionaryCandidate[]; dictionary_names: string[]; entries: DictEntry[]; timing?: DictionaryLookupTiming; }
