...
export interface DictEntry { entry_key: string; dict_name: string; headword: string; definition_html: string; style_profile: string; content_blocks: DictionaryContentBlock[]; match_type: "headword" | "reading" | "fuzzy"; links: DictionaryLink[]; }
