...
export interface DictionaryLookup { query: string; reading: string | null; selected_target: string | null; candidates: DictionaryCandidate[]; dictionary_names: string[]; entries: DictEntry[]; timing?: DictionaryLookupTiming; }
