...
| P4 活用链与整体构词 | 已完成 | 状态机、形态 occurrence、GiNZA 整体构词及候选查询已接入统一入口 | 后续消费规范基本形式、父链、内部查询及候选状态 |
...
P0 至 P4 已完成本阶段实现。P4 输出三来源证据、对齐、统一结构、活用链、形态 occurrence、整体构词和查询候选。接续工作为 P5 词典交互；构式义项、表达识别、词汇范围竞争和阅读单位按所属阶段实施。P4 验证证据及语言边界见 [P4 样本输出复核](p4_sample_review.md)。
