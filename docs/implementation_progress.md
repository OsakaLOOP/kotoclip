...
更新日期：2026-09-22。完整范围以 [TODO](TODO.md) 和 [模块索引](README.md) 为准。各阶段记录实现、应用调用和验收证据。
...
| P5 词典查询与后续语言能力 | 待实施 | 已有矩阵引擎、候选查询及组件；本轮三例定向查询记录了聚合和默认选择问题 | P5A–P5C 完成多粒度目标、词典决定及交互；P5D 独立完成语法、表达和修正协议 |
...
P0 至 P3 已完成。P4 的 token、活用链与构词候选已具备后续开发基础，核心契约的待核验项独立处理。下一模块负责词典验证、查询聚合与选择，再接入短文本交互。原 P4 的构式义项、表达识别、实例修正和投影任务按 [TODO](TODO.md) 分别归属 P5D、P6、P7。当前证据见 [P4 样本输出复核](p4_sample_review.md)，本轮职责核对见 [P4 完成范围与后续开发对齐](p4_handoff.md)。
