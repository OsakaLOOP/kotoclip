...
| P5 词典查询与后续语言能力 | 待实施 | 已有矩阵引擎、候选查询及组件；三例定向查询记录了聚合和默认选择问题 | P5A–P5C 完成多粒度目标、词典绑定、决定及交互；P5D 独立完成语法与表达 |
...
P0 至 P3 已完成。P4 的 token、活用链与构词候选已具备后续开发基础，核心契约的待核验项独立处理。P5A／P5B 负责词典查询、绑定、聚合和选择，P5C 接入短文本交互；P5D 独立完成语法与表达，P6 接入完整阅读器，P7 负责个人状态和导出。当前证据见 [P4 样本输出复核](p4_sample_review.md)，职责核对见 [P4 完成范围与后续开发对齐](p4_handoff.md)。
